"""``torch.index_copy_.2_spyre`` kernel extracted from a torch-spyre Inductor trace.

The ``@triton.jit`` function body verbatim, from torch-spyre's Inductor
output for Meta-Llama-3.1-8B-Instruct's traced ``torch.index_copy_.2`` op
(``aten.index_put_.default(arg0_1, [None, None, arg1_1], arg2_1)``, a KV-cache
style scatter along dim 2 of a ``f16[1, 8, 2048, 128]`` buffer); see
``torch-spyre/test_results_triton_20260731_095001/torch.index_copy_.2_spyre/
torch_compile_debug/run_2026_07_31_11_01_42_625040-pid_466731/
