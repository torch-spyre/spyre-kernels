"""``torch.mul.14_spyre`` kernel extracted from a torch-spyre Inductor trace.

The ``@triton.jit`` function body (from the ``async_compile.triton(...)``
source string) verbatim, from torch-spyre's Inductor output for
Meta-Llama-3.1-8B-Instruct's traced ``torch.mul.14`` op
...
torch.mul.14_spyre/torch_compile_debug/
run_2026_07_14_13_18_57_807199-pid_272781/torchinductor/
