"""``torch.neg.1_spyre`` kernel extracted from a torch-spyre Inductor trace.
...
Meta-Llama-3.1-8B-Instruct's traced ``torch.neg.1`` op
(``aten.neg.default(arg0_1)`` — unary — on a logical ``f16[1, 32, 12, 64]``
tensor); see
``torch-spyre/test_results_triton_20260714_120532/torch.neg.1_spyre/
torch_compile_debug/run_2026_07_14_12_30_13_355781-pid_260721/
...
Inductor-side metadata (``config={'XBLOCK': 768}``, ``triton_meta``,
...
def triton_unk_fused_neg_0(in_ptr0, out_ptr0, xnumel, XBLOCK : tl.constexpr):
    ...
    desc_1 = tl.make_tensor_descriptor(out_ptr0, shape=[32, 12, 1, 1, 64], strides=[768, 64, 64, 64, 1], block_shape=[1, 12, 1, 1, 64])
